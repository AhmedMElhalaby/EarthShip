            ...
            <div class="row masonry pos-r">
                ...
                <div class="masonry-item col-md-12">
                    <div class="bgc-white p-20 bd">
                        <h6 class="c-grey-900">Add Prohibited Category </h6>
                        <div class="mT-30">
                            <form class="form-horizontal" role="form" method="POST" action="{{ url('admin/prohibited-category/postAdd') }}" enctype="multipart/form-data">
                                {{ csrf_field() }}

            ...
            <div class="row masonry pos-r">
                ...
                <div class="masonry-item col-md-12">
                    <div class="bgc-white p-20 bd">
                        <h6 class="c-grey-900">Add Membership </h6>
                        <div class="mT-30">
                            <form class="form-horizontal" role="form" method="POST" action="{{ url('admin/membership/postAdd') }}">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group{{ $errors->has('billed') ? ' has-error' : '' }}">
                                    ...
                                    <select name="billed" class="form-control" id="billed" name="billed" value="{{ old('billed') }}">
